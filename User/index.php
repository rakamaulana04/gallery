...
<head>
  ...
  <link rel="icon" type="image/png" href="../Assets/image/logo/gambar.png"/>
  <!-- Bootstrap 3.3.6 -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php?page=beranda&aksi=aktif" class="logo" class="brand-link">
      ...
      <span class="logo-mini"><img src="../Assets/image/logo/gambar.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" height="40px" width="40px" style="opacity: .8"></span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><img src="../Assets/image/logo/gambar.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" height="40px" width="40px" style="opacity: .8"><b> GALERI </b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="../Assets/image/user/user.jpg<?php echo $ft_akun;?>" class="user-image" alt="User Image">
              <span class="hidden-xs"><?php echo $dataakun['username'];?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="../Assets/image/user/user.jpg<?php echo $ft_akun;?>" class="img-circle" alt="User Image">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="?page=komentar&aksi=tampil_komentar">
            <i class="fa fa-file-image-o"></i> <span>Status</span>
        ...
        <li>
          <a href="?page=album&aksi=tampil_album">
            <i class="fa fa-folder-open"></i> <span>Albumku</span>
            <span class="pull-right-container">
            </span>
          </a>
        </li>
